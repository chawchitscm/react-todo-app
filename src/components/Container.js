  ...
  return (
    <div className="container">
      <div className="header">
        ...
        <button onClick={props.switchTheme} data-testid="switch" id="switch-btn">
          { props.theme !== "light" && 
      ...
      <div className="input-wrapper">
        <input type="text" value={text} onChange={e => setText(e.target.value)} onKeyDown={handleEnter} data-testid="todo-input" />
      </div>
